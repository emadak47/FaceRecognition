...
DROP TABLE IF EXISTS `Account`, `Branch`, `CurrentAccount`, `Customer`, `LogHistory`, `Merchant`, `Phone`, `SavingsAccount`, `Transaction`;
...
CREATE TABLE `LogHistory` (
  ...
  PRIMARY KEY(`customer_id`, `login_date`,`login_time`),
  FOREIGN KEY (`customer_id`) REFERENCES `Customer`(`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- DELETE FROM `Transaction`; DELETE FROM `Merchant`; DELETE FROM `CurrentAccount`; DELETE FROM `SavingsAccount`; DELETE FROM `Account`; DELETE FROM `Branch`; DELETE FROM `Phone`; DELETE FROM `LogHistory`; DELETE FROM `Customer`;
...
INSERT INTO `LogHistory` VALUES (1, CURTIME(), CURDATE());
INSERT INTO `LogHistory` VALUES (2, CURTIME(), "2021-11-02");
INSERT INTO `LogHistory` VALUES (3, "17:32:23", CURDATE());
INSERT INTO `LogHistory` VALUES (4, "23:46:10", "2019-05-01");
INSERT INTO `LogHistory` VALUES (5, "15:49:11", "1999-11-30");
...
INSERT INTO `LogHistory` VALUES (1, "19:01:10", "2021-11-22");
...
INSERT INTO `SavingsAccount` VALUES (12, 500, "USD");
